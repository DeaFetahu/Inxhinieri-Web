   ...
   <?php include "header.php"?>
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              ...
              <img src="fotot/prishtine.jpg" style="width:100%; height:25%">
              <div class="text">Prishtina</div>
            </div>
          
            <div class="mySlides fade">
              <div class="numbertext">2 / 4</div>
              <img src="fotot/gjilan.png" style="width:100%; height:25%">
              <div class="text">Gjilan</div>
            </div>
          
            <div class="mySlides fade">
              <div class="numbertext">3 / 4</div>
              <img src="fotot/ferizaj.jpg" style="width:100%; height:25%">
              <div class="text">Prishtine</div>
            </div>
    
            <div class="mySlides fade">
                <div class="numbertext">4 / 4</div>
                <img src="fotot/gjakove.jpg" style="width:100%; height:25%">
                <div class="text">Gjakova</div>
              </div>
