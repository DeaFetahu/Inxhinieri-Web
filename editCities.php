...
$dhenat=new qytetet();
$myId=$_GET['id'];
$records=$dhenat->lexoDhenatSipasIDsCities($myId);
/*
echo "<pre>";
        var_dump($records);
echo"<pre>";
*/
   if(isset($_POST['edit'])){
       ...
       if($myId==$dhenat->getId()){
        ...
        echo $dhenat->updateDhenatCities();

        echo
       " <script>
            alert('Te dhenat jane perditesuar me sukses !');
            document.location='displayCities.php';
        </script>";
       }
   }
?>
...
<body>
  ...
  <section class="home-section">
    ...
    <h3>Edit!</h3>
        Photo:
        <input type="text" name="emri"  class="box" value="<?php echo $records['foto'];?>">
        <br>
        Name:
        <input type="text" name="foto" class="box" value="<?php echo $records['emri'];?>">
        <br>
