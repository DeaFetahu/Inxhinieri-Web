...
if(isset($_POST['submit'])){
    ...
    if(isset($_POST ['teksti1'])){
    $regj -> setEmri($_POST['teksti1']);}

    if(isset($_POST ['teksti2'])){
    $regj -> setUrl($_POST['teksti2']);}
...
<body>
  ...
  <section class="home-section">
    ...
    <h3>ADD A NEW SLIDE!</h3>
        ...
        <br>
        Text1:
        <input type="text" name="teksti1" class="box">
        <br>
        Text2:
        <input type="text" name="teksti2" class="box">
        <br>
